...
const dynamicBikeMovements = `  {
  ...
  },
  {
    ...
    image: "assets/stretches/generated/front-back-leg-swings.png",
    seconds: 15,
    sides: true,
  ...
  },
  {
    ...
    image: "assets/stretches/generated/lateral-leg-swings.png",
    seconds: 15,
    sides: true,
  ...
  },
  {
    id: "ankle-circles",
    name: "Ankle Circles",
    image: "assets/stretches/generated/ankle-circles.png",
    seconds: 15,
    sides: true,
...
const originalBeforeCycling = /  \{\r?\n    id: "before-cycling",[\s\S]*?\r?\n  \},(?=\r?\n  \{\r?\n    id: "after-run",)/;
  ...
  return {
    ...
    transform(code, id) {
      ...
      if (!next.includes('id: "hip-circles"')) {
        if (!movementAnchor.test(next)) {
          throw new Error("Zen Chad pre-bike patch could not find the movement catalogue anchor.");
        }
        next = next.replace(movementAnchor, `${dynamicBikeMovements}  {\n    id: "wall-calf-stretch",`);
      }

      if (originalBeforeCycling.test(next)) {
