...
const { cosmeticById, equipCosmetic, isCosmeticOwned } = await import("../src/cosmetics.ts");
...
const boughtHair = purchaseShopItem({ ...defaultData, zenPoints: 45 }, "porter-robinson-nurture-hair", "2026-09-02T12:00:00.000Z");
...
assert.equal(silverLilac?.paperDollLayer, "/assets/status/paper-doll/layers/hair/silver-lilac-tousled-hair-clean.png");
const boughtSilverLilac = purchaseShopItem({ ...defaultData, zenPoints: 55 }, "silver-lilac-tousled-hair", "2026-09-02T12:05:00.000Z");
